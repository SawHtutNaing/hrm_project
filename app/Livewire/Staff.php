...
class Staff extends Component
{
    ...
    {
        $staffs = ModelsStaff::paginate(20);

        return view('livewire.staff', ['staffs' => $staffs]);
    }
    ...
    public function save()
    {
        ...
        if ($this->isEdit) {
            ModelsStaff::findOrFail($this->staff->id)->update($data);
        } else {
    ...
    {
        $this->staff = ModelsStaff::findOrFail($id);
