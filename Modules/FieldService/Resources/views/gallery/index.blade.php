...
@section('photo_gallery_list_active', 'active')
...
@section('title')
<!--begin::Heading-->
<h1 class="text-dark fw-bold my-0 fs-2">Photo Gallery</h1>
<!--end::Heading-->
<!--begin::Breadcrumb-->
<ul class="breadcrumb fw-semibold fs-base my-1">
    <li class="breadcrumb-item text-muted">Photo</li>
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="container-xxl" id="">
        ...
        {{-- <livewire:fieldservice.ImageGralleryComponent :campaign_id="9" /> --}}
        <livewire:PhotoGralleryComponent />
    </div>
    <!--end::Container-->
</div>
